/**
 * COMPOSIÇÃO
 * TIPOS DE AGREGAÇÃO MAIS FORTE.
 * AS PARTES NÃO EXISTEM SEM O TODO
 * INDICA UMA DEPENDÊNCIA DE CICLO DE VIDA.
 * EXEMPLO: CASA COMPÕE CÔMODO,SE A CASA É DESTRUÍDA,OS CÔMODOS TAMBÉM SÃO.
 * OS CÔMODOS NASCEM E MORREM COM A CASA.
 * ISSO É COMPOSSIÇÃO
 * EXEMPLO 2:
 * UM PEDIDO CONTÉM UMA LISTA DE PRODUTOS.eM VEZ DE HERANÇA USAMOS COMPOSIÇÃO PORQEU UM PEDIDO 
